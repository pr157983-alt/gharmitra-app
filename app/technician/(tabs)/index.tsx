          ...
          <>
            ...
            {data.newJobs.map((j) => (
              <View key={j.id} style={styles.alert}>
                ...
                <Text style={styles.muted}>{j.customer_name} · {j.phone}</Text>
                <Text style={styles.muted} numberOfLines={2}>{j.address}</Text>
...
const styles = StyleSheet.create({
  ...
  hello: { fontSize: 22, fontWeight: '800', color: Colors.neutral[900] },
  sub: { fontSize: 12, color: Colors.neutral[500], marginTop: 4, maxWidth: 200 },
